...
print(system.time(testResults <- fitModelIterative(maxIter=5, niterMCMC=500, loadDat="interactiveFit.RData"))) #params fit maxIter times, mean fit maxIter-1 times
